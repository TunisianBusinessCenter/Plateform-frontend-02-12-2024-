...
@Component({
  selector: 'app-home-algerie',
  templateUrl: './home-algerie.component.html',
  styleUrls: ['./home-algerie.component.css']
})
export class HomeAlgerieComponent implements OnInit {
