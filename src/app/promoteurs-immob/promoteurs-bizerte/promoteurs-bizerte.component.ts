...
@Component({
  selector: 'app-promoteurs-bizerte',
  templateUrl: './promoteurs-bizerte.component.html',
  styleUrls: ['./promoteurs-bizerte.component.css']
})
export class PromoteursBizerteComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.agencieService.getAgencieBizerte().subscribe((data: any) => {
      this.AgenciesBizerte = data;
      this.AgenciesBizerte.sort((a, b) => {
