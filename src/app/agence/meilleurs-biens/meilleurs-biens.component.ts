...
@Component({
  selector: 'app-meilleurs-biens',
  templateUrl: './meilleurs-biens.component.html',
...
export class MeilleursBiensComponent implements OnInit {
  ...
  constructor(private http:HttpClient, private MeilleursBiens : MeilleursBiensService,private sanitizer: DomSanitizer,private activatedRoute: ActivatedRoute,private agencieService: AgenciesService,    private modalService: NgbModal,    private breakpointObserver: BreakpointObserver,
  ) { 
  ...
  CommerceService() {
    ...
    this.MeilleursBiens.setIdAgency(this.Agency?.id)
