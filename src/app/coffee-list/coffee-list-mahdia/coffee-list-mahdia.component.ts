...
@Component({
  selector: 'app-coffee-list-mahdia',
  templateUrl: './coffee-list-mahdia.component.html',
  styleUrls: ['./coffee-list-mahdia.component.css']
})
export class CoffeeListMahdiaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.Servicemateriaux.getMateriauxEquipement().subscribe((data: any) => {
      ...
      this.AgenciesCoffee = data.filter((item: any) => item.phone_number_commercial === "yes" && item.region === "mahdia");
