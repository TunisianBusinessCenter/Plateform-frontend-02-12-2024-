...
@Component({
  selector: 'app-navbar-carousel-home',
...
export class NavbarCarouselHomeComponent implements OnInit {
  agenceID = '5494'
  allAgencies: any
  ...
  slideActivate(ngbSlideEvent: NgbSlideEvent) {
    ...
    if (ngbSlideEvent.source === NgbSlideEventSource.ARROW_LEFT ||
      ngbSlideEvent.source === NgbSlideEventSource.ARROW_RIGHT) {
      // Assuming you have a reference to your NgbCarousel instance
      this.carousel.interval = 1000; // Set the interval to 2 seconds
    }
  }
