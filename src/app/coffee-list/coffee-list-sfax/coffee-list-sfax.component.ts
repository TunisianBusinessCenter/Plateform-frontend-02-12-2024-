...
@Component({
  selector: 'app-coffee-list-sfax',
  templateUrl: './coffee-list-sfax.component.html',
  styleUrls: ['./coffee-list-sfax.component.css']
})
export class CoffeeListSfaxComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.Servicemateriaux.getMateriauxEquipement().subscribe((data: any) => {
      ...
      this.AgenciesCoffee = data.filter((item: any) => item.phone_number_commercial === "yes" && item.region === "sfax");
